...
class Plan 
{
    ...
    {
        // parent::__construct($codigo, $colCanales, $importe);
        $this->codigo = $codigo;
    ...
    public function preciosCanales()
    {
        $precio = 0;
        foreach ($this->getColCanales() as $unCanal) {
            $precio = $precio + $unCanal->getImporte();
        }
        return $precio;
    }
    ...
    public function __toString()
    {
        ...
        $cadena = $cadena . "Precio de los canales: " . $this->preciosCanales() . "\n";
